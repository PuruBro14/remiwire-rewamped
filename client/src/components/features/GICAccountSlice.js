...
const GICAccountSlice = createSlice({
  name: "blockedAccount",
  initialState,
  reducers: {
...
export const { reducer } = GICAccountSlice;
export const { setformValue } = GICAccountSlice.actions;
export default GICAccountSlice.reducer;
