...
const NRIRepatriation = createSlice({
  name: "NRIRepatriation",
  initialState,
  reducers: {
...
export const { reducer } = NRIRepatriation;
export const { setformValue } = NRIRepatriation.actions;
export default NRIRepatriation.reducer;
